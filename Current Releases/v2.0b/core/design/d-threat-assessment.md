...
| Maturity 3 - Pro-active improvement of threat coverage throughout the organization | Periodicly review application risk profiles | Improve quality by automated analysis |
...
### Activity
The goal of this activity is to thoroughly understand the risk level of all applications within the organizations to focus the effort of your software assurance activities where it really matters.
