...
export class AuthService {
  ...
  corona_rtc()
  {
    return this.http.get(environment.apiBaseUrl + '/rtc_corona')
    .pipe(map(res => res.json()));
  }
  verifyotp(user)
  {
  ...
  persentage() {
    return this.http.get(environment.apiBaseUrl + '/persentage')
    .pipe(map(res => res.json()));
  }
  dovagraph(){
    return this.http.get(environment.apiBaseUrl + '/dovagraph')
    .pipe(map(res => res.json()));
  }

// **************************OPERATIONS******************************
dovagraph_ope(){
  return this.http.get(environment.apiBaseUrl + '/dovagraph_ope')
  .pipe(map(res => res.json()));
}
OperationsPRFirstGraph() {
  return this.http.get(environment.apiBaseUrl + '/OperationsFirstGraph')
    .pipe(map(res => res.json()));

}
OperationsPRSecondGraph() {
  return this.http.get(environment.apiBaseUrl + '/OperationsSecondGraph')
    .pipe(map(res => res.json()));

}
OperationsPRThirdGraph() {
  return this.http.get(environment.apiBaseUrl + '/OperationsThirdGraph')
    .pipe(map(res => res.json()));

}
OperationsPRTable() {
  return this.http.get(environment.apiBaseUrl + '/oprreg_la_tab')
    .pipe(map(res => res.json()));
}
OperationsPMTable() {
  return this.http.get(environment.apiBaseUrl + '/pmreg_la_tab')
    .pipe(map(res => res.json()));
}
OperationsBackupTable() {
  return this.http.get(environment.apiBaseUrl + '/backupreg_la_tab')
    .pipe(map(res => res.json()));
}
OperationsLoggingTable() {
  return this.http.get(environment.apiBaseUrl + '/lmreg_la_tab')
    .pipe(map(res => res.json()));
}
OperationsTVMTable() {
  return this.http.get(environment.apiBaseUrl + '/tvmreg_la_tab')
    .pipe(map(res => res.json()));
}
OperationsIsacTable() {
  return this.http.get(environment.apiBaseUrl + '/icreg_la_tab')
    .pipe(map(res => res.json()));
}
OperationsCosTable() {
  return this.http.get(environment.apiBaseUrl + '/cosreg_la_tab')
    .pipe(map(res => res.json()));
}
// ******************OPERATIONS END***********************
}
