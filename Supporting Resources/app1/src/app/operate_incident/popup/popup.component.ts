...
export class OICPopupComponent implements OnInit {
...
todo="Show the uploaded file(s)";
  ...
  constructor( private authService: AuthService,private tokenStorage: TokenStorageService,
    public dialogRef: MatDialogRef<OICPopupComponent>,   //@Optional() is used to prevent error if no data is passed
