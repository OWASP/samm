...
export class IMPPopupComponent implements OnInit {
...
todo="Show the uploaded file(s)";
  ...
  constructor( private authService: AuthService,private tokenStorage: TokenStorageService,
    public dialogRef: MatDialogRef<IMPPopupComponent>,   //@Optional() is used to prevent error if no data is passed
...
download(obj1)
{
  this.authService.implement_defect_table().subscribe(data =>
    {
       if(data.success)
       {
         //console.log(data);
