...
export class AuthService {
  ...
  implement_defect_table()
  {
    return this.http.get(environment.apiBaseUrl + '/implement_defect_table')
    .pipe(map(res => res.json()));
  }
  get_select_options(user)
  {
    return this.http.post(environment.apiBaseUrl + '/get_select_options_implement_defect',user)
    .pipe(map(res => res.json()));
  }
  getuploads(user){
    return this.http.post(environment.apiBaseUrl + '/getuploaded_implement_defect',user)
    .pipe(map(res => res.json()));
  }
  firstgraph()
  {
  ...
  edit_table(user)
  {
    return this.http.put(environment.apiBaseUrl + '/implement_defect_edit',user)
    .pipe(map(res => res.json()));
  }
  upload_files(user)
  {
  ...
  thirdgraph()
  {
    return this.http.get(environment.apiBaseUrl + '/implement_defect_third_graph')
    .pipe(map(res => res.json()));
  }
}
