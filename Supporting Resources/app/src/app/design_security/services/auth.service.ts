...
export class AuthService {
  ...
  fourthgraph(user)
  {
    return this.http.post(environment.apiBaseUrl + '/last_graph_design',user)
    .pipe(map(res => res.json()));
  }
  design_security_table()
  {
    return this.http.get(environment.apiBaseUrl + '/design_security_table')
    .pipe(map(res => res.json()));
  }
  get_select_options(user)
  {
    return this.http.post(environment.apiBaseUrl + '/get_select_options_design_security',user)
    .pipe(map(res => res.json()));
  }
  getuploads(user){
    return this.http.post(environment.apiBaseUrl + '/getuploaded_design_security',user)
    .pipe(map(res => res.json()));
  }
  firstgraph()
  {
  ...
  edit_table(user)
  {
    return this.http.put(environment.apiBaseUrl + '/design_security_edit',user)
    .pipe(map(res => res.json()));
  }
  upload_files(user)
  {
  ...
  thirdgraph()
  {
    return this.http.get(environment.apiBaseUrl + '/design_security_third_graph')
    .pipe(map(res => res.json()));
  }
}

// Versatile SAMM - services