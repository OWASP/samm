...
import {AuthService} from '../../services/auth.service';
 ...
 import { ISBPopupComponent } from '../../popup/popup.component';
...
export class ISBTableComponent implements OnInit {
 ...
 /* open(action,obj,content: any) {
  ...
  loadtab() {
    //console.log('Loading');
    // alert('hi');
    this.authService.implement_secure_build_table().subscribe(data => {
         if (data.success) {
          // console.log(data);
           this.x = data.values;
  ...
  openDialog(action,obj) {
    obj.action = action;
    const dialogRef = this.dialog.open(ISBPopupComponent, {
      width: '1000px',
      height: '600px',
