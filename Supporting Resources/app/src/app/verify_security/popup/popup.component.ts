...
export class VERSPopupComponent implements OnInit {
...
todo="Show the uploaded file(s)";
  ...
  constructor( private authService: AuthService,private tokenStorage: TokenStorageService,
    public dialogRef: MatDialogRef<VERSPopupComponent>,   //@Optional() is used to prevent error if no data is passed
