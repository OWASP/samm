...
export class AuthService {
  ...
  fourthgraph(user)
  {
   ...
   verify_arch_table()
  {
    return this.http.get(environment.apiBaseUrl + '/verify_arch_table')
    .pipe(map(res => res.json()));
  }
  get_select_options(user)
  {
    return this.http.post(environment.apiBaseUrl + '/get_select_options_verify_arch',user)
    .pipe(map(res => res.json()));
  }
  getuploads(user){
    return this.http.post(environment.apiBaseUrl + '/getuploaded_verify_arch',user)
    .pipe(map(res => res.json()));
  }
  firstgraph()
  {
  ...
  edit_table(user)
  {
    return this.http.put(environment.apiBaseUrl + '/verify_arch_edit',user)
    .pipe(map(res => res.json()));
  }
  upload_files(user)
  {
  ...
  thirdgraph()
  {
    return this.http.get(environment.apiBaseUrl + '/verify_arch_third_graph')
    .pipe(map(res => res.json()));
  }
}
