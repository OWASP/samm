...
export class AuthService {
  ...
  fourthgraph(user)
  {
    return this.http.post(environment.apiBaseUrl + '/last_graph_implement',user)
    .pipe(map(res => res.json()));
  }
  implement_secure_deploy_table()
  {
    return this.http.get(environment.apiBaseUrl + '/implement_secure_deploy_table')
    .pipe(map(res => res.json()));
  }
  get_select_options(user)
  {
    return this.http.post(environment.apiBaseUrl + '/get_select_options_implement_secure_deploy',user)
    .pipe(map(res => res.json()));
  }
  getuploads(user){
    return this.http.post(environment.apiBaseUrl + '/getuploaded_implement_secure_deploy',user)
    .pipe(map(res => res.json()));
  }
  firstgraph()
  {
  ...
  edit_table(user)
  {
    return this.http.put(environment.apiBaseUrl + '/implement_secure_deploy_edit',user)
    .pipe(map(res => res.json()));
  }
  upload_files(user)
  {
  ...
  thirdgraph()
  {
    return this.http.get(environment.apiBaseUrl + '/implement_secure_deploy_third_graph')
    .pipe(map(res => res.json()));
  }
}
