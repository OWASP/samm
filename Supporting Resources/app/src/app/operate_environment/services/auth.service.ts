...
export class AuthService {
  ...
  operate_environment_table()
  {
    return this.http.get(environment.apiBaseUrl + '/operate_environment_table')
    .pipe(map(res => res.json()));
  }
  get_select_options(user)
  {
    return this.http.post(environment.apiBaseUrl + '/get_select_options_operate_environment',user)
    .pipe(map(res => res.json()));
  }
  getuploads(user){
    return this.http.post(environment.apiBaseUrl + '/getuploaded_operate_environment',user)
    .pipe(map(res => res.json()));
  }
  firstgraph()
  {
  ...
  edit_table(user)
  {
    return this.http.put(environment.apiBaseUrl + '/operate_environment_edit',user)
    .pipe(map(res => res.json()));
  }
  upload_files(user)
  {
  ...
  thirdgraph()
  {
    return this.http.get(environment.apiBaseUrl + '/operate_environment_third_graph')
    .pipe(map(res => res.json()));
  }
}
