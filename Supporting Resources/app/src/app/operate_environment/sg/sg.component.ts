...
export class  OETSgComponent implements OnInit {
  totalscore: {};
    ...
    [
      {
        ...
        "value": this.operate_environment_rating,
        "full": 100
      }, 
      {
        "category": "Operational Management",
        "name": "Operational Management",
        "value": this.operate_operational_rating,
        "full": 100
      },
      {
        "category": "Incident Management",
        "name": "Incident Management",
        "value": this.operate_incident_rating,
        "full": 100
      }
    ];
