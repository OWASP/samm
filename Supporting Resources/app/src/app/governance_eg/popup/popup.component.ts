...
export class GEGPopupComponent implements OnInit {
...
todo="Show the uploaded file(s)";
  ...
  constructor( private authService: AuthService,private tokenStorage: TokenStorageService,
    public dialogRef: MatDialogRef<GEGPopupComponent>,   //@Optional() is used to prevent error if no data is passed
...
download(obj1)
{
  this.authService.governance_education_table().subscribe(data =>
    {
       if(data.success)
       {
         //console.log(data);
...
var check={
  ...
  "secpractice":'Education & Guidance'
};
