...
import {AuthService} from '../../services/auth.service';
 ...
 import { VEREPopupComponent } from '../../popup/popup.component';
...
export class VERETableComponent implements OnInit {
 ...
 /* open(action,obj,content: any) {
  ...
  loadtab() {
    //console.log('Loading');
    // alert('hi');
    this.authService.verify_requirement_table().subscribe(data => {
         if (data.success) {
          // console.log(data);
           this.x = data.values;
  ...
  "secpractice":'Requirements Driven Testing'
    };
  ...
  openDialog(action,obj) {
    obj.action = action;
    const dialogRef = this.dialog.open(VEREPopupComponent, {
      width: '1000px',
      height: '600px',
