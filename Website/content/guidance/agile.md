...
See [Metrics](/model/governance/strategy-and-metrics/stream-b/) in the SAMM Model.
...
{{< responsive-image  "/img/pages/SAMMAgileRequirementsProcess.png" "SAMM Agile requirements process">}}
